...
$sql = "SELECT Distinct Module FROM Papers where College='$college' and Course='$course'";
...
while ($row = mysqli_fetch_assoc ($result_id)){
  $module =$row["Module"];
$sql2 = "SELECT Year,Season FROM Papers where College='$college' and Course='$course' and Module='$module'";
...
or die ("Cannot execute query");
 ...
 $link="uploads"."/".$college."/".$course."/".$module."/".$row["Year"]."_".$row["Season"].".pdf";
     printf($link);

 $coursestr.="<p>"."<a href='".$link."' download>".$row["Year"]." ".$row["Season"]."</a></p>
					";
    }
    $coursestr.="</div>";
}
